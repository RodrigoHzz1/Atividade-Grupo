...
public class TripulacaoResponseDTO {
    ...
    public TripulacaoResponseDTO() {
    }

    public TripulacaoResponseDTO(Long id, String nomeFuncionario, String funcao, String plataforma, LocalDate dataInicioConfinamento, LocalDate dataFimConfinamento) {
        this.id = id;
